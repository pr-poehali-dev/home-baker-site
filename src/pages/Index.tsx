...
const reviews = [
  {
    name: "Елизавета",
    occasion: "27 ноября 2025",
    text: "Быстро договорились, тортик был готов к назначенному времени, хорошая упаковка, внешний вид отличный, на вкус превосходный. Рекомендую!",
    stars: 5,
    avatar: "Е",
  },
  {
    name: "Екатерина",
    occasion: "21 января",
    text: "Очень нежные, вкусные тортики! Каждый месяц заказываем дочке и всегда очень мягкий бисквит с восхитительной начинкой. Дизайн всегда на высоте!",
    stars: 5,
    avatar: "Е",
  },
  {
    name: "Елена",
    occasion: "14 февраля",
    text: "Все отлично! Торт вкусный! Все, как договорились и в срок. Рекомендую!",
    stars: 5,
    avatar: "Е",
  },
  {
    name: "Ирина",
    occasion: "27 апреля",
    text: "Торт был шикарный и очень вкусный, работа сложна выполнена на 100%. Торт молочная девочка с прослойкой банан и клубники — всё безупречно!",
    stars: 5,
    avatar: "И",
  },
];
              ...
              <RevealSection key={i}>
                <div className="bg-white rounded-3xl p-8 shadow-md card-hover border border-border/50">
                  <div className="flex items-start gap-4 mb-4">
                    <div className="w-12 h-12 rounded-2xl bg-rose text-white flex items-center justify-center text-lg font-bold font-body shrink-0">
                      {r.avatar}
                    </div>
                    <div>
